...
const PathWatcherHandleMethods = [_]python_c.PyMethodDef{ .{ .ml_name = "cancel\x00", .ml_meth = @ptrCast(&path_watcher_handle_cancel), .ml_flags = python_c.METH_NOARGS, .ml_doc = "Cancel the path watcher\x00" }, .{ .ml_name = null, .ml_meth = null, .ml_flags = 0, .ml_doc = null } };
