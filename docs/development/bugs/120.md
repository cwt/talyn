...
- **Lesson**: [Memory §Lesson 25 (Use-After-Free)](../lessons/01-memory-and-reference-counting.md); sibling of BUG-115 (in-flight callback references a freed owner) — mirror its pattern.
