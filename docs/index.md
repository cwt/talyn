...
- [✅ PRIORITY 1: Zig 0.15.2 & 0.16.0 Compatibility — DONE](development/priorities/1-zig-0-16-0-compatibility-2026.md)
- [🟡 PRIORITY 2: Network & Transport — ALL DONE (7/7)](development/priorities/2-network-transport-all-7-7.md)
- [🔵 PRIORITY 4: Standard Compatibility & GC Stability — ✅ DONE (2026-05-10)](development/priorities/4-standard-compatibility-gc-stability-2026-05.md)
...
- [✅ PRIORITY 22: Fused User-Space Socket State Machine — ABANDONED (2026-05-28 → 2026-05-29)](development/priorities/22-fused-user-space-socket-state-machine-2026.md)
...
- [Historical Artifacts (Leviathan Heritage)](historical/index.md)
