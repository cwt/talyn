...
def fetch_cves():
    ...
    req = urllib.request.Request(
        url,
        headers={"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) TalynCVEBot/1.0"}
    )
    try:
...
def analyze_cve(cve_id, description):
    ...
    applicable_keywords = ["read", "write", "poll", "connect", "accept", "recv", "send", "timeout", "cancel", "teardown", "setup"]
